    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block  sidebar collapse corPrimaria">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link text-light" href="#adm">
          ...
          <li class="nav-item">
            <a class="nav-link text-light" href="#coordenador">
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
              </svg>
              Coordenadores
...
while ($linha= mysqli_fetch_assoc ( $dados3)) {
   ...
   $dataVST= $linha ['dataVST'];
    ...
    onClick= " . '"' . "pegar_dados( $id , '$nome','$usuarioVST')" . '"'. ">Excluir</a>
    </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <p> Realmente deseja EXCLUIR <b ID="nome_pessoa">Nome da pessoa</b>?</p>
      </div>
...
function pegar_dados(id, nome , usuarioVST){ 

    document.getElementById("nome_pessoa").innerHTML = nome; 
    document.getElementById("cod_pessoa1").value = nome; 
