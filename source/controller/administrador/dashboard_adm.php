          ...
          <li class="nav-item">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="cadastra_coordenador.html">Cadastrar coodenadores</a></li>
                <li><a class="dropdown-item" href="cadastra_adm.html">Cadastrar administradores</a></li>
                <li><a class="dropdown-item" href="cadastra_visita.html">Cadastrar visitas</a></li>
              </ul>
            </div>
          </li>
