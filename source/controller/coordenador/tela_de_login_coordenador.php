...
<main class="form-signin text-center">
  ...
  <form action="login_coordenador.php" method="POST">
    ...
    <div class="form-floating">
      <input name="cpf" type="text" class="form-control" id="floatingInput" placeholder="Ex = 122.208.404.09">
...
<br>
    ...
    <div class="form-floating">
      <input name="senha" type="password" class="form-control" id="floatingPassword"  placeholder="Ex = 123ola321">
