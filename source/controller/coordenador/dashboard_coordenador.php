...
<body style="background-color: rgb(41, 63, 136);">
 ...
 <!--navbar inicio-->   
<header class="navbar navbar-dark flex-md-nowrap p-0 shadow corPrimaria" style="height: 60px;">

  
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-2" href="#">
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block corPrimaria sidebar collapse">
          ...
          <li class="nav-item">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="../administrador/tela_de_cadastro_visita.php">Cadastrar visitas</a></li>
                    <li><a class="dropdown-item text-danger" href="#">indispónivel</a></li>
                </ul>
              </div>
          </li>

          <li class="nav-item">
            <a class="nav-link text-light" href="#visita">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg-light"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <p class="text-white">_</p>
          <a href="relatorio_coordenador.php" type="button" class="btn btn-dark">
              Gerar Relatório
